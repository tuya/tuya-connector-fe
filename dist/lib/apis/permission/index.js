...
var getEntireRoles = function (opts) {
    ...
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var result, pageSize, pageNo, loopFetchRoleList;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    loopFetchRoleList = function () {
                        return exports.getRoleList(pageNo, pageSize, opts).then(function (res) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
...
var editRoleName = function (params, opts) {
    if (opts === void 0) { opts = { data: {} }; }
    return service_1.default(tslib_1.__assign(tslib_1.__assign({ apiMethodName: "editRoleName", url: "/roles", method: "PUT" }, opts), { data: tslib_1.__assign(tslib_1.__assign({}, opts.data), params) })).then(function () {
        return true;
    });
};
...
var grantPermissionByRole = function (params, opts) {
    if (opts === void 0) { opts = { data: {} }; }
    return service_1.default(tslib_1.__assign(tslib_1.__assign({ apiMethodName: "grantPermissionByRole", url: "/roles/permissions", method: "PUT" }, opts), { data: tslib_1.__assign(tslib_1.__assign({}, opts.data), params) })).then(function () {
        return true;
    });
};
...
var getRolePermissionDetail = function (roleCode, opts) {
    if (opts === void 0) { opts = { data: {} }; }
    return service_1.default(tslib_1.__assign(tslib_1.__assign({ apiMethodName: "getRolePermissionDetail", url: "/roles/permissions", method: "GET" }, opts), { params: tslib_1.__assign(tslib_1.__assign({}, opts.data), { roleCode: roleCode }) }));
};
